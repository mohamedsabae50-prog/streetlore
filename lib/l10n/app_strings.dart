...
class AppStrings {
  ...
  static const Map<String, Map<String, String>> _v = {
    ...
    'ach_critic_desc': {'en': 'Post 10 reviews', 'ar': 'انشر 10 تقييمات'},
    'ach_photographer_name': {'en': 'Photographer', 'ar': 'مُصوِّر'},
    'ach_photographer_desc': {'en': 'Upload 5 photos', 'ar': 'ارفع 5 صور'},
