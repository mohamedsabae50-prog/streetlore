...
$payload = @{
    tag_name = "v1.0.11"
    name = "v1.0.11 - 5 fixes: session, filter, best-time, routing, AI"
    body = $releaseBody
    draft = $false
    prerelease = $false
...
try {
    $release = Invoke-RestMethod -Uri "https://api.github.com/repos/mohamedsabae50-prog/streetlore/releases/tags/v1.0.11" -Headers $headers
...
$apkPath = "D:\codes\streetlore\build\app\outputs\flutter-apk\streetlore-v1.0.11-arm64.apk"
...
$uploadUrlWithName = $uploadUrl + '?name=streetlore-v1.0.11-arm64.apk'
