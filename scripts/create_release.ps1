...
$payload = @{
    tag_name = "v1.0.10"
    name = "v1.0.10 - Robust session restore + AR/EN place fields"
    body = $releaseBody
    draft = $false
    prerelease = $false
...
try {
    $release = Invoke-RestMethod -Uri "https://api.github.com/repos/mohamedsabae50-prog/streetlore/releases/tags/v1.0.10" -Headers $headers
...
$apkPath = "D:\codes\streetlore\build\app\outputs\flutter-apk\streetlore-v1.0.10-arm64.apk"
...
$uploadUrlWithName = $uploadUrl + '?name=streetlore-v1.0.10-arm64.apk'
