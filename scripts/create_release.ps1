...
$payload = @{
    tag_name = "v1.0.9"
    name = "v1.0.9 - New compass logo + persistent sign-in"
    body = $releaseBody
    draft = $false
    prerelease = $false
...
try {
    $release = Invoke-RestMethod -Uri "https://api.github.com/repos/mohamedsabae50-prog/streetlore/releases/tags/v1.0.9" -Headers $headers
...
$apkPath = "D:\codes\streetlore\build\app\outputs\flutter-apk\streetlore-v1.0.9-arm64.apk"
...
$uploadUrlWithName = $uploadUrl + '?name=streetlore-v1.0.9-arm64.apk'
