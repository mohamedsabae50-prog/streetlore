...
$payload = @{
    tag_name = "v1.0.8"
    name = "v1.0.8 - Updated Google OAuth Web Client ID"
    body = $releaseBody
    draft = $false
    prerelease = $false
...
try {
    $release = Invoke-RestMethod -Uri "https://api.github.com/repos/mohamedsabae50-prog/streetlore/releases/tags/v1.0.8" -Headers $headers
...
$apkPath = "D:\codes\streetlore\build\app\outputs\flutter-apk\streetlore-v1.0.8-arm64.apk"
...
$uploadUrlWithName = $uploadUrl + '?name=streetlore-v1.0.8-arm64.apk'
