...
List<Map<String, dynamic>> _places() => [
  ...
  },
  {
    ...
    'open_hours': '9:30 AM - 5:00 PM (Closed Friday)',
    'review_count': 3421,
    'price_level': 'moderate',
  ...
  },
  {
    ...
    'open_hours': '9:00 AM - 2:00 PM (Sun-Thu, by arrangement)',
    'review_count': 567,
    'price_level': 'free',
    'price_note': 'Free, donations welcome',
    'is_hidden_gem': false,
  ...
  },
  {
    ...
    'open_hours': '9:00 AM - 4:00 PM (may be closed for restoration)',
    'review_count': 634,
    'price_level': 'cheap',
    'price_note': 'Egyptian EGP 25, Foreigner EGP 150',
    'is_hidden_gem': true,
  ...
  {
    'id': '41',
    'name': 'Jesuit Church of Cleopatra',
    'description':
        'كنيسة كاثوليكية تاريخية في حي كليوباترا، من أجمل كنائس الإسكندرية اللاتينية بعمارتها ونجفها وفنائها الهادئ.',
    'image_url':
    ...
    'lat': 31.2285,
    'lng': 29.9543,
    'address': 'شارع كنيسة الجزويت، كليوباترا',
  ...
  },
  {
    ...
    'description':
        'المتحف اليوناني الروماني بعد تجديده بالكامل - آلاف القطع من العصرين البطلمي والروماني، من تماثيل وعملات وفسيفساء. محطة أساسية لفهم تاريخ إسكندرية القديمة.',
    'image_url':
        'https://images.unsplash.com/photo-1555488205-d5e67846cf40?w=800&q=80',
    'rating': 4.7,
    'category': 'Culture',
    'lat': 31.2002,
    'lng': 29.9135,
    'address': 'شارع المشير، وسط البلد، الإسكندرية',
    'open_hours': '9:00 AM - 5:00 PM',
    'review_count': 1230,
    'price_level': 'moderate',
    'price_note': 'Egyptian EGP 40, Foreigner EGP 300',
    'is_hidden_gem': false,
    'price_local_egp': 40,
    'price_foreigner_egp': 300,
    'is_featured': true,
  },
  {
    'id': '44',
    ...
    'description':
        'قصر الأميرة فاطمة الزهراء يعرض مجوهرات ومقتنيات أسرة محمد علي. لوحات سقف وزجاج معشق يستحقوا الزيارة لوحدهم.',
    'image_url':
  ...
  },
  {
    ...
    'description':
        'فيلا الفنان محمود سعيد على طراز إيطالي تعرض لوحاته وأعمال رواد الفن المصري الحديث. متحف هادئ وقريب من حديقة أنطونيادس.',
    'image_url':
    ...
    'open_hours': '9:00 AM - 4:00 PM (Closed Monday)',
    'review_count': 410,
    'price_level': 'cheap',
    'price_note': 'Egyptian EGP 20, Foreigner EGP 100',
    'is_hidden_gem': true,
    'price_local_egp': 20,
    'price_foreigner_egp': 100,
    'is_featured': false,
  },
  {
    ...
    'name': 'Cavafy Museum',
    'description':
        'بيت الشاعر اليوناني قسطنطين كفافي اللي عاش فيه 25 سنة. مكتبته ومخطوطاته وأثاثه الأصلي محفوظين زي ما سيبهم.',
    'image_url':
    ...
    'lat': 31.1979,
    'lng': 29.9084,
    'address': 'شارع شرم الشيخ، محطة الرمل، الإسكندرية',
    'open_hours': '10:00 AM - 5:00 PM (Closed Monday)',
    'review_count': 320,
    'price_level': 'cheap',
    'price_note': 'Egyptian EGP 15, Foreigner EGP 60',
    'is_hidden_gem': true,
    'price_local_egp': 15,
    'price_foreigner_egp': 60,
    'is_featured': false,
  ...
  {
    'id': '47',
    'name': 'Sayed Darwish Theatre (Alexandria Opera House)',
    'description':
        'دار أوبرا إسكندرية من 1921 بتصميم مستوحى من أوبرا فيينا. حفلات أوركسترا وأوبرا ومسرح طوال السنة - شيك برنامجهم قبل ما تروح.',
    'image_url':
    ...
    'review_count': 760,
    'price_level': 'moderate',
    'price_note': 'Ticket prices vary by show',
    'is_hidden_gem': false,
    'is_featured': false,
  },
  {
    'id': '48',
    'name': 'El Max Canals (Venice of Alexandria)',
    'description':
        'قرية المكس للصيادين - قنوات مائية وبيوت ملونة وقوارب خشبية، بيلقبوها "فينيسيا إسكندرية". أحلى وقت للزيارة قبل الغروب.',
    'image_url':
    ...
    'lat': 31.1554,
    'lng': 29.8235,
    'address': 'المكس، العجمي، الإسكندرية',
    'open_hours': 'Open all day',
    'review_count': 690,
    'price_level': 'free',
    'price_note': 'Free to walk around',
    'is_hidden_gem': true,
    'is_featured': false,
  },
  {
    'id': '49',
    'name': 'El-Nabi Daniel Mosque',
    'description':
        'من أقدم مساجد إسكندرية في قلب وسط البلد. بيتردد إن الموقع مرتبط بقبر الإسكندر الأكبر - من أكتر الأماكن غموضًا في المدينة.',
    'image_url':
    ...
    'lat': 31.1972,
    'lng': 29.9053,
    'address': 'شارع النبي دانيال، محطة الرمل، الإسكندرية',
    'open_hours': 'Open all day',
    'review_count': 1150,
    'price_level': 'free',
  ...
  {
    'id': '50',
    'name': 'El-Attarine Mosque',
    'description':
        'مسجد العطارين في قلب السوق القديم - اتبنى مكان كنيسة القديس أثناسيوس ومازال محتفظ بأعمدتها الجرانيتية الأثرية.',
    'image_url':
  ...
  },
  {
    ...
    'name': 'Alexandria Zoo',
    'description':
        'حديقة حيوان النزهة - مكان عائلي كلاسيكي فيه أسود وزرافات وقرود وطيور نادرة. يوم كامل للأطفال بأسعار رمزية.',
    'image_url':
    ...
    'lat': 31.2154,
    'lng': 29.9481,
    'address': 'النزهة، سموحة، الإسكندرية',
    'open_hours': '9:00 AM - 5:00 PM',
    'review_count': 1340,
    'price_level': 'cheap',
    'price_note': 'Egyptian EGP 10, Foreigner EGP 50',
    'is_hidden_gem': false,
    'price_local_egp': 10,
    'price_foreigner_egp': 50,
    'is_featured': false,
  },
  {
    'id': '52',
    'name': 'Antoniades Gardens',
    'description':
        'حدائق أنطونيادس من القرن التاسع عشر - تماثيل رخامية يونانية بين أشجار نادرة ونوافير. هادية جدًا ومش معروفة كفاية.',
    'image_url':
    ...
    'lat': 31.2129,
    'lng': 29.9448,
    'address': 'أنطونيادس، سموحة، الإسكندرية',
    'open_hours': '8:00 AM - 5:00 PM',
    'review_count': 370,
    'price_level': 'cheap',
    'price_note': 'Small entry fee',
    'is_hidden_gem': true,
    'price_local_egp': 5,
    'price_foreigner_egp': 30,
    'is_featured': false,
  },
  {
    ...
    'description':
        'أكواريوم إسكندرية جنب قلعة قايتباي - أسماك البحر المتوسط وكائنات بحرية نادرة في أحواض صخرية قديمة. محطة حلوة مع القلعة.',
    'image_url':
    ...
    'lat': 31.2141,
    'lng': 29.8829,
    'address': 'بحري، الأنفوشي، الإسكندرية',
    'open_hours': '9:00 AM - 5:00 PM',
    'review_count': 890,
    'price_level': 'cheap',
    'price_note': 'Egyptian EGP 15, Foreigner EGP 60',
  ...
  {
    'id': '54',
    'name': 'El-Mansheya Square',
    'description':
        'ميدان المنشية - قلب إسكندرية التجاري منذ عصر محمد علي. مباني كلاسيكية ومحلات عتيقة ونبض المدينة الحقيقي.',
    'image_url':
    ...
    'lat': 31.1956,
    'lng': 29.9008,
    'address': 'ميدان المنشية، وسط البلد، الإسكندرية',
    'open_hours': 'Open all day',
    'review_count': 620,
    'price_level': 'free',
    'price_note': 'Free to walk around',
  ...
  {
    'id': '55',
    'name': 'Saad Zaghloul Square',
    'description':
        'ميدان سعد زغلول على الكورنيش مباشرة - تمثال سعد وسط الميدان وقصر رمسيس والبحر قدامك. نقطة تجمع أسكندرانية أصيلة.',
    'image_url':
    ...
    'lat': 31.2015,
    'lng': 29.9064,
    'address': 'الكورنيش، محطة الرمل، الإسكندرية',
    'open_hours': 'Open all day',
    'review_count': 540,
    'price_level': 'free',
    'price_note': 'Free to walk around',
  ...
  },
  {
    ...
    'name': 'Raml Tram Ride',
    'description':
        'ترام الرملة - أقدم ترام في أفريقيا شغال من 1863. اركب الخط الأزرق من محطة الرمل لآخر الخط وشوف المدينة زي أهلها.',
    'image_url':
    ...
    'lat': 31.1991,
    'lng': 29.9035,
    'address': 'محطة ترام الرمل، الإسكندرية',
    'open_hours': '6:00 AM - 12:00 AM (suspended during 2026 works)',
    'review_count': 830,
    'price_level': 'cheap',
    'price_note': 'Ticket a few EGP',
    'is_hidden_gem': false,
    'price_local_egp': 5,
    'price_foreigner_egp': 5,
    'is_featured': false,
  },
  {
    'id': '57',
    ...
    'description':
        'مقابر مصطفى كامل من القرن الثالث قبل الميلاد - أربع مقابر صخرية بيلينية في حي سكني عادي. أقل أثر مزدحم في المدينة.',
    'image_url':
    ...
    'lat': 31.1892,
    'lng': 29.9194,
    'address': 'مصطفى كامل، الإسكندرية',
    'open_hours': '9:00 AM - 5:00 PM',
    'review_count': 210,
    'price_level': 'cheap',
    'price_note': 'Egyptian EGP 10, Foreigner EGP 60',
    'is_hidden_gem': true,
    'price_local_egp': 10,
    'price_foreigner_egp': 60,
    'is_featured': false,
  ...
  {
    'id': '58',
    'name': 'El Shatby Necropolis',
    'description':
        'مقابر الشاطبي من العصر البطلمي على شكل بيوت - واجهات وأعمدة وأفنية محفورة في الصخر. جنبها مقابر الأنفوشي مباشرة.',
    'image_url':
...
List<Map<String, dynamic>> _tours(List<Map<String, dynamic>> places) => [
  ...
  },
  {
    ...
    'description':
        'الجانب المخفي من الإسكندرية - قنوات المكس ومقابر سرية لا يعرفها السياح.',
    'duration': '4 Hours',
    'image_url':
        'https://images.unsplash.com/photo-1539650116574-75c0c6d73f6e?auto=format&fit=crop&w=800&q=80',
    'place_ids': ['48', '58', '17', '27'],
  },
  {
    'id': 't5',
    'title': 'Beach Day',
  ...
  },
  {
    ...
    'description':
        'تنوع الإسكندرية الديني - مساجد وكنائس ومعبد يهودي في قلب المدينة.',
    'duration': '4 Hours',
    'image_url':
        'https://images.unsplash.com/photo-1564769625392-651b2c4444a4?auto=format&fit=crop&w=800&q=80',
    'place_ids': ['10', '34', '40', '18'],
  },
  {
    'id': 't7',
    'title': 'Museums & Royal Jewels',
    'description':
        'يوم متاحف كامل - اليوناني الروماني والمجوهرات الملكية ومحمود سعيد والمتحف الوطني.',
    'duration': '5 Hours',
    'image_url':
        'https://images.unsplash.com/photo-1555488205-d5e67846cf40?w=800&q=80',
    'place_ids': ['43', '44', '45', '11'],
  },
  {
    'id': 't8',
    'title': 'Ancient Necropolises',
    'description':
        'مقابر إسكندرية القديمة - من كوم الشقافة إلى مصطفى كامل والشاطبي وأنفوشي.',
    'duration': '4 Hours',
    'image_url':
        'https://images.unsplash.com/photo-1539650116574-75c0c6d73f6e?auto=format&fit=crop&w=800&q=80',
    'place_ids': ['4', '57', '58', '17'],
  },
  {
    'id': 't9',
    'title': 'Family Day',
    'description':
        'يوم عائلي كامل - حديقة الحيوان وأنطونيادس والأكواريوم وحدائق المنتزه.',
    'duration': 'Full Day',
    'image_url':
        'https://images.unsplash.com/photo-1564507592333-c60657eea523?auto=format&fit=crop&w=800&q=80',
    'place_ids': ['51', '52', '53', '3'],
  },
  {
    'id': 't10',
    'title': 'Raml Heritage Walk',
    'description':
        'مشي في تراث الرمل - شارع فؤاد وميدان المنشية وسعد زغلول ومسرح سيد درويش.',
    'duration': '3 Hours',
    'image_url':
        'https://images.unsplash.com/photo-1480796927426-f609979314bd?auto=format&fit=crop&w=800&q=80',
    'place_ids': ['39', '54', '55', '47'],
  },
];
